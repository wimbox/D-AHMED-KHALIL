...
class SyncManager {
    ...
    async triggerCloudSync(forcePushNoGuard = false) {
        ...
        if (!this.isOnline()) { // Assuming isOnline() is a method that checks internet connectivity
            this.dispatchSyncStatus('offline');
            return false;
        }

        const docId = 'clinic_master_data'; // Assuming this.globalDocId is 'clinic_master_data'
